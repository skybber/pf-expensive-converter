...
public class InjectionResolver
{
                                          ...
                                          Class<?> injectionPointClass, Annotation... qualifiers)
    {
        ...
        if (!startup /*|| (injectionPointType == javax.enterprise.inject.spi.BeanManager.class && injectionPointClass == javax.enterprise.inject.spi.BeanManager.class)*/)
        {
        ...
        List<Bean<?>> fastComponentList = null;
        if (!returnAll && fastMatching)
        {
        	fastComponentList = webBeansContext.getBeanManagerImpl().getBeanFastLookup(injectionPointType);
        }

        if (fastComponentList != null && !fastComponentList.isEmpty())
        {
        	resolvedComponents.addAll(fastComponentList);
        }
        else
        {
        ...
        {
            //System.out.println("" + fastMatching + " " + injectionPointType.getTypeName());
        }
